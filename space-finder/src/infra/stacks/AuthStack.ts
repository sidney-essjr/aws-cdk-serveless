...
export class AuthStack extends Stack {
  ...
  constructor(scope: Construct, id: string, props: AuthStackProps) {
    ...
    this.createRoles(props.photosBucket.bucketArn);
    this.attachRoles();
  ...
  private createUserPoolClient() {
    this.userPoolClient = this.userPool.addClient("SpaceUserPoolCliente", {
      authFlows: {
  ...
  private createRoles(photosBucketArn: string) {
